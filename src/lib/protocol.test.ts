...
describe('MustangProtocol', () => {
    ...
    describe('Static Parsing Methods', () => {
        ...
        it('should parse preset name from real hardware trace', () => {
            const rawData = [
                0x1c, 0x01, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
                0x42, 0x72, 0x75, 0x74, 0x61, 0x6c, 0x20, 0x4d, 0x65, 0x74, 0x61, 0x6c, 0x20, 0x49, 0x49, 0x00, 
        ...
        it('should parse special character preset name from real hardware trace', () => {
            const rawData = [
                0x1c, 0x01, 0x04, 0x00, 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
                0x57, 0x68, 0x61, 0x74, 0x20, 0x74, 0x68, 0x65, 0x20, 0x23, 0x5e, 0x5b, 0x21, 0x00, 0x00, 0x00, 
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
            ];
            const data = new Uint8Array(rawData);
